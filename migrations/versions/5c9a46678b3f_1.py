...
Revision ID: 5c9a46678b3f
Revises: 1f3ba7084849
Create Date: 2020-10-21 19:06:36.344661
...
revision = '5c9a46678b3f'
down_revision = '1f3ba7084849'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('all_order', sa.Column('oDate', sa.DateTime(), nullable=True))
    op.add_column('all_order', sa.Column('oPrice', mysql.DOUBLE(asdecimal=True), nullable=True))
    op.add_column('all_order', sa.Column('orderID', sa.Integer(), autoincrement=True, nullable=False))
    ...
    op.drop_column('all_order', 'orderid')
    op.drop_column('all_order', 'odate')
    op.drop_column('all_order', 'uid')
    op.drop_column('all_order', 'oprice')
...
def downgrade():
    ...
    op.create_foreign_key('detailed_order_ibfk_2', 'detailed_order', 'all_order', ['orderid'], ['orderid'])
    ...
    op.drop_column('cart', 'cNumber')
    op.add_column('all_order', sa.Column('oprice', mysql.DOUBLE(asdecimal=True), nullable=True))
    op.add_column('all_order', sa.Column('uid', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True))
    op.add_column('all_order', sa.Column('odate', mysql.DATETIME(), nullable=True))
    op.add_column('all_order', sa.Column('orderid', mysql.INTEGER(display_width=11), autoincrement=True, nullable=False))
    op.create_foreign_key('all_order_ibfk_1', 'all_order', 'user', ['uid'], ['uid'])
