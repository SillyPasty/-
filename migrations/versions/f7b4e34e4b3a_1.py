...
Revision ID: f7b4e34e4b3a
Revises: 8bfe236bc74f
Create Date: 2020-10-21 18:54:24.039106
...
revision = 'f7b4e34e4b3a'
down_revision = '8bfe236bc74f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.drop_table('order')
    op.add_column('cart', sa.Column('Product_itemID', sa.Integer(), nullable=True))
    op.add_column('cart', sa.Column('User_userID', sa.Integer(), nullable=True))
    ...
    op.create_foreign_key(None, 'cart', 'user', ['User_userID'], ['userID'])
    op.create_foreign_key(None, 'cart', 'product', ['Product_itemID'], ['itemID'])
    ...
    op.add_column('detailed_order', sa.Column('Official_user_official_userID', sa.Integer(), nullable=True))
    op.add_column('detailed_order', sa.Column('Order_orderID', sa.Integer(), nullable=True))
    op.add_column('detailed_order', sa.Column('Product_itemID', sa.Integer(), nullable=True))
    ...
    op.create_foreign_key(None, 'detailed_order', 'all_order', ['Order_orderID'], ['orderID'])
    op.create_foreign_key(None, 'detailed_order', 'product', ['Product_itemID'], ['itemID'])
    op.create_foreign_key(None, 'detailed_order', 'official_user', ['Official_user_official_userID'], ['official_userID'])
    ...
    op.add_column('product', sa.Column('Official_user_official_userID', sa.Integer(), nullable=True))
    op.add_column('product', sa.Column('Type_typeID', sa.Integer(), nullable=True))
    ...
    op.create_foreign_key(None, 'product', 'official_user', ['Official_user_official_userID'], ['official_userID'])
    op.create_foreign_key(None, 'product', 'type', ['Type_typeID'], ['typeID'])
